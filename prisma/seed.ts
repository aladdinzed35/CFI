...
const SITE_SETTINGS: readonly SeedSetting[] = [
  ...
  { key: 'contact.address', value: 'Tanger, Maroc — À COMPLÉTER', group: 'contact' },
...
const STAFF: readonly SeedUser[] = [
  {
    ...
    bio: "Fondateur du centre. Vingt ans de formation professionnelle à Tanger, dont douze passées à monter des dispositifs en alternance avec les entreprises de la zone franche.",
...
const TESTIMONIALS: readonly SeedTestimonial[] = [
  {
    ...
    authorRole: 'Chargée de communication, Tanger',
    rating: 5,
    order: 1,
    isFeatured: true,
    quote: {
  ...
  },
  {
    ...
    authorRole: 'Étudiante en informatique, Tétouan',
    rating: 5,
    order: 3,
    isFeatured: true,
    quote: {
